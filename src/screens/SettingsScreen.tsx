...
const styles = StyleSheet.create({
    ...
    iconContainer: { width: 34, height: 34, borderRadius: DesignSystem.radius.sm, backgroundColor: DesignSystem.colors.primary + '26', justifyContent: 'center', alignItems: 'center', marginRight: 14 },
    dangerIconBg: { backgroundColor: DesignSystem.colors.errorRed + '1F' },
    rowContent: { flex: 1 },
